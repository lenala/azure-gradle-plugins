...
import com.lenala.azure.gradle.webapp.auth.AuthConfiguration;
import com.lenala.azure.gradle.webapp.auth.AzureAuthFailureException;
import com.lenala.azure.gradle.webapp.auth.AzureAuthHelper;
...
import com.lenala.azure.gradle.webapp.configuration.DeploymentSlotDeployTarget;
import com.lenala.azure.gradle.webapp.configuration.WebAppDeployTarget;
import com.lenala.azure.gradle.webapp.handlers.HandlerFactory;
import com.lenala.azure.gradle.webapp.handlers.RuntimeHandler;
...
public class DeployTask extends DefaultTask implements AuthConfiguration {
    ...
    private static final String SUBSCRIPTION_ID_KEY = "com.lenala.azure.subscriptionId";
    ...
    public Authentication getAuthenticationSettings() {
        ...
        for (Field f : authSetting.getClass().getDeclaredFields()) {
            try {
                String key = String.format("com.lenala.azure.auth.%s", f.getName());
